...
?>                													<div class="modal-header">
                                                                        <h4 class="modal-title">Editar docencia</h4>
                                                                        <button class="close" data-dismiss="modal" aria-label="Cerrar">
                                                                            <span aria-hidden="true">&times;</span>
                                                                        </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                    <form enctype="multipart/form-data" action="scripts/formularios/sni/editar/sql/trayectoria_profesional/docencia.php?ident=<?php echo($ident)?>" method="POST">


                                                                    <div class="form-group">
                                                                          <label for="inst_otor" required>Nombre del programa educativo:</label>
                                                                          <input type="text" class="form-control inst_otor" name="nom_prog_educ" placeholder="" required value="<?php echo $mostrar['nombre_programa_educativo']?>">
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="nom_curso" required>Nombre del curso o asignatura:</label>
                                                                          <input type="text" class="form-control nom_curso" name="nom_curso" placeholder="" required value="<?php echo $mostrar['nombre_curso']?>">
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="nom_inst" required>Nombre de institución en educación superior IES:</label>
                                                                          <input type="text" class="form-control nom_inst" name="nom_inst" placeholder="" required value="<?php echo $mostrar['nombre_institucion_ies']?>">
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                          <label for="horas_tot">Horas totales del curso o asignatura:</label>
                                                                          <select name="horas_tot" class="form-control custom-select" required>
                                                                            <option value="<?php echo $mostrar['horas_totales_curso']?>">"<?php echo $mostrar['horas_totales_curso']?>"</option>
