...
?>  
                                                                    ...
                                                                    <form enctype="multipart/form-data" action="scripts/formularios/sni/editar/sql/formacion_academica/grados_academicos_y_capacitacion.php?ident=<?php echo($ident)?>" method="POST">
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <select name="estat_grad" class="form-control custom-select" required>
                                                                            <option value="<?php echo $mostrar['estatus']?>">"<?php echo $mostrar['estatus']?>"</option>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control titulacion" name="titulacion" placeholder="" required value="<?php echo $mostrar['opciones_de_titulacion']?>">
                                                                    </div>


                                                                     <div class="form-group">
                                                                          <label for="inst_otor" required>Institución otorgante:</label>
                                                                          <input type="text" class="form-control inst_otor" name="inst_otor" placeholder="" required value="<?php echo $mostrar['nombre_institucion']?>">
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                <input type="text" name="fecha_obtencion" class="tuiker form-control" required value="<?php echo $mostrar['fecha_obtencion_titulo']?>">
                                                                                <label for="datepicker" class="input-group-addon generic_btn"><i class="fa fa-calendar" aria-hidden="true"></i></label>    
                                                                            </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control tip_form" name="tip_form" placeholder="" required value="<?php echo $mostrar['tipo_formacion_continua']?>">
                                                                        </div>


                                                                        <div class="form-group">
                                                                          <label for="form_conti" required>Nombre de formación continua:</label>
                                                                          <input type="text" class="form-control form_conti" name="form_conti" placeholder="" required value="<?php echo $mostrar['nombre_formacion_continua']?>">
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <select name="ano_for" class="form-control custom-select" required>
                                                                            <option value="<?php echo $mostrar['ano_formacion_continua']?>">"<?php echo $mostrar['ano_formacion_continua']?>"</option>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control inst_form_conti" name="inst_form_conti" placeholder="" required value="<?php echo $mostrar['institucion_formacion_continua']?>">
                                                                        </div>
                                                                     ...
                                                                     <div class="form-group">
                                                                          ...
                                                                          <select name="horas_tot" class="form-control custom-select" required>
                                                                            <option value="<?php echo $mostrar['horas_totales_formacion_continua']?>">"<?php echo $mostrar['horas_totales_formacion_continua']?>"</option>
                                                                        ...
                                                                        <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control area_conti" name="area_conti" placeholder="" required value="<?php echo $mostrar['area_de_conocimiento_formacion_continua']?>">
                                                                        </div>
