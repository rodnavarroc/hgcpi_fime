...
?>  
                                                                    ...
                                                                    <form enctype="multipart/form-data" action="scripts/formularios/sni/editar/tesis_diplomados_editar.php?ident=<?php echo($ident)?>" method="POST">

                                                                    
                                                                    <div class="form-group">
                                                                          <label for="institucion" required>Institución:</label>
                                                                          <input type="text" class="form-control institucion" name="institucion" placeholder="" value="<?php echo $mostrar['institucion'] ?>" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <select name="ayuda_innova" class="form-control custom-select" required>
                                                                            <option value="<?php echo $mostrar['programa_pnpc']?>">"<?php echo $mostrar['programa_pnpc']?>"</option>
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                <input type="text" name="fecha_aproba_tesis" value="<?php echo $mostrar['fecha_aprobacion_tesis'] ?>" class="tuiker form-control" required>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <select name="estado_tesis" class="form-control custom-select" required>
                                                                            <option value="<?php echo $mostrar['estado_tesis']?>">"<?php echo $mostrar['estado_tesis']?>"</option>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control area_tesis" name="area_tesis" placeholder="" value="<?php echo $mostrar['area_conocimiento_tesis'] ?>" required>
                                                                         </div>

                                                                        <div class="form-group">
                                                                            <label for="campo_tesis" required>Campo de la tesis:</label>
                                                                            <input type="text_art" class="form-control campo_tesis" name="campo_tesis" placeholder="" value="<?php echo $mostrar['campo_conocimiento_tesis'] ?>" required>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="disciplina_tesis" required>Disciplina de la tesis:</label>
                                                                            <input type="text" class="form-control disciplina_tesis" name="disciplina_tesis" placeholder="" value="<?php echo $mostrar['disciplina_conocimiento_tesis'] ?>" required>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="subdisciplina_tesis" required>Subdisciplina de la tesis:</label>
                                                                            <input type="text" class="form-control subdisciplina_tesis" name="subdisciplina_tesis" placeholder="" value="<?php echo $mostrar['subdisciplina_conocimiento_tesis'] ?>" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <select name="pais_tesis" class="form-control custom-select" required>
                                                                            <option value="<?php echo $mostrar['pais_tesis']?>">"<?php echo $mostrar['pais_tesis']?>"</option>
                                                                            <option value="Afganistán">Afganistán</option>
                                                                            <option value="Albania">Albania</option>
                                                                            <option value="Alemania">Alemania</option>
                                                                            <option value="Andorra">Andorra</option>
                                                                     ...
                                                                     <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control grado_tesis" name="grado_tesis" placeholder="" value="<?php echo $mostrar['grado_academico_tesis'] ?>" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                            <label for="datepicker" class="control-label">Fecha de obtención de grado:</label>
                                                                            <div class="controls">
                                                                                <input type="text" name="fecha_obten_grado" value="<?php echo $mostrar['fecha_obtencion_grado'] ?>" class="tuiker form-control" required>
                                                                                <label for="datepicker" class="input-group-addon generic_btn"><i class="fa fa-calendar" aria-hidden="true"></i></label>    
                                                                            </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control nom_diplomado" name="nom_diplomado" placeholder="" value="<?php echo $mostrar['nombre_diplomado'] ?>" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="nom_curso_asig" required>Nombre del curso o asignatura:</label>
                                                                          <input type="text" class="form-control nom_curso_asig" name="nom_curso_asig" placeholder="" value="<?php echo $mostrar['nombre_curso_asignatura'] ?>"  required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="ano_diplo">Año del diplomado:</label>
                                                                          <select name="ano_diplo" class="form-control custom-select" required>
                                                                            <option value="<?php echo $mostrar['ano_diplomado']?>">"<?php echo $mostrar['ano_diplomado']?>"</option>
                                                                        ...
                                                                        <div class="form-group">
                                                                          ...
                                                                          <select name="horas_tot_diplomado" class="form-control custom-select" required>
                                                                            <option value="<?php echo $mostrar['horas_diplomado']?>">"<?php echo $mostrar['horas_diplomado']?>"</option>
                                                                        ...
                                                                        <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control area_diplo" name="area_diplo" placeholder="" value="<?php echo $mostrar['area_conocimiento_diplomado'] ?>" required>
                                                                         </div>
