...
$sql="SELECT * FROM detalle_usuario_grupos_investigacion WHERE id='$ident' AND usuario_idusuario='$idusuario'";
...
?>  
                                                                    ...
                                                                    <form enctype="multipart/form-data" action="scripts/formularios/sni/editar/grupos_investigacion_editar.php?ident=<?php echo($ident)?>" method="POST">

                                                                    <div class="form-group">
                                                                          <label for="nom_grupo" required>Nombre del grupo:</label>
                                                                          <input type="text" class="form-control nom_grupo" name="nom_grupo" placeholder="" value="<?php echo $mostrar['nombre_grupo'] ?>" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control nom_respo_grupo" name="nom_respo_grupo" placeholder="" value="<?php echo $mostrar['nombre_lider'] ?>" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="prim_ap_respo_grupo" required>Primer apellido del responsable / líder del grupo:</label>
                                                                          <input type="text" class="form-control prim_ap_respo_grupo" name="prim_ap_respo_grupo" placeholder="" value="<?php echo $mostrar['primer_apellido_lider'] ?>" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="seg_ap_respo_grupo" required>Segundo apellido del responsable / líder del grupo:</label>
                                                                          <input type="text" class="form-control seg_ap_respo_grupo" name="seg_ap_respo_grupo" placeholder="" value="<?php echo $mostrar['segundo_apellido_lider'] ?>" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="inst_adscrip" required>Institución de adscripción del responsable:</label>
                                                                          <input type="text" class="form-control inst_adscrip" name="inst_adscrip" placeholder="" value="<?php echo $mostrar['institucion_adscripcion_lider'] ?>" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="tot_invest" required>Total de investigadores:</label>
                                                                          <input type="text" class="form-control tot_invest" name="tot_invest" placeholder="" value="<?php echo $mostrar['total_investigadores'] ?>" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="impacto" required>Impacto:</label>
                                                                          <input type="text" class="form-control impacto" name="impacto" placeholder="" value="<?php echo $mostrar['impacto'] ?>" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="colab" required>Colaboración:</label>
                                                                          <input type="text" class="form-control colab" name="colab" placeholder="" value="<?php echo $mostrar['colaboracion'] ?>" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="area_grupo" required>Área:</label>
                                                                          <input type="text" class="form-control area_grupo" name="area_grupo" placeholder="" value="<?php echo $mostrar['area_conocimiento_grupo'] ?>" required>
                                                                         </div>

                                                                        <div class="form-group">
                                                                            <label for="campo_grupo" required>Campo:</label>
                                                                            <input type="text_art" class="form-control campo_grupo" name="campo_grupo" placeholder="" value="<?php echo $mostrar['campo_grupo'] ?>" required>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="disciplina_grupo" required>Disciplina:</label>
                                                                            <input type="text" class="form-control disciplina_grupo" name="disciplina_grupo" placeholder="" value="<?php echo $mostrar['disciplina_grupo'] ?>" required>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="subdisciplina_grupo" required>Subdisciplina:</label>
                                                                            <input type="text" class="form-control subdisciplina_grupo" name="subdisciplina_grupo" placeholder="" value="<?php echo $mostrar['subdisciplina_grupo'] ?>" required>
                                                                    </div>
<!--
                                                                    <hr>
