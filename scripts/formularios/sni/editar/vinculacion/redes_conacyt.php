...
$sql="SELECT * FROM detalle_usuario_redes_tematicas_conacyt WHERE id='$ident' AND usuario_idusuario='$idusuario'";
...
?>  																	                                       
                                                                    ...
                                                                    <form enctype="multipart/form-data" action="scripts/formularios/sni/editar/redes_conacyt_editar.php?ident=<?php echo($ident)?>" method="POST">

                                                                    <div class="form-group">
                                                                          <label for="red_conacyt" required>Red temática CONACYT:</label>
                                                                          <input type="text" class="form-control red_conacyt" name="red_conacyt" placeholder="" value="<?php echo $mostrar['red_tematica_conacyt'] ?>" required>
                                                                    </div>
