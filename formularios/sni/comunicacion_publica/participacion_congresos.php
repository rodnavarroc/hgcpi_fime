																	<div class="modal-header">
                                                                        <h4 class="modal-title">Nueva participación en congresos</h4>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control nom_congre" name="nom_congre" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="tit_trab" required>Título del trabajo:</label>
                                                                          <input type="text" class="form-control tit_trab" name="tit_trab" placeholder="" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                          <label for="pais_congre">País:</label>
                                                                          <select name="pais_congre" class="form-control custom-select" required>
                                                                            <option selected>Seleccione...</option>
...
<!--
                                                                    ...
                                                                    <div class="form-group">
                                                                          <label for="nom_colab_cong" required>Nombre(s):</label>
                                                                          <input type="text" class="form-control nom_colab_cong" name="nom_colab_cong" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="prim_ap_cong" required>Primer apellido:</label>
                                                                          <input type="text" class="form-control prim_ap_cong" name="prim_ap_cong" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="seg_ap_cong" required>Segundo apellido:</label>
                                                                          <input type="text" class="form-control seg_ap_cong" name="seg_ap_cong" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="genero_cong" required>Género:</label>
                                                                          <input type="text" class="form-control genero_cong" name="genero_cong" placeholder="" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                          <label for="area_cong" required>Área:</label>
                                                                          <input type="text" class="form-control area_cong" name="area_cong" placeholder="" required>
                                                                         </div>

                                                                        <div class="form-group">
                                                                            <label for="campo_cong" required>Campo:</label>
                                                                            <input type="text_art" class="form-control campo_cong" name="campo_cong" placeholder="" required>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="disciplina_cong" required>Disciplina:</label>
                                                                            <input type="text" class="form-control disciplina_cong" name="disciplina_cong" placeholder="" required>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="subdisciplina_cong" required>Subdisciplina:</label>
