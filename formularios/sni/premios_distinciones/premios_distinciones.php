                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control tipo_reconocimiento" name="tipo_reconocimiento" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="nivel_prem_dist" required>Nivel:</label>
                                                                          <input type="text" class="form-control nivel_prem_dist" name="nivel_prem_dist" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="nom_prem_dist" required>Nombre de las distinción:</label>
                                                                          <input type="text" class="form-control nom_prem_dist" name="nom_prem_dist" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="inst_otorgo_premio" required>Institución que otorgó el premio o distinción:</label>
                                                                          <input type="text" class="form-control inst_otorgo_premio" name="inst_otorgo_premio" placeholder="" required>
                                                                    </div>
