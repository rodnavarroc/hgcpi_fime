																	<div class="modal-header">
                                                                        <h4 class="modal-title">Nuevo desarrollo de software</h4>
                                                                        <button class="close" data-dismiss="modal" aria-label="Cerrar">
                                                                            <span aria-hidden="true">&times;</span>
                                                                        </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                    <form enctype="multipart/form-data" action="scripts/formularios/sni/agregar/produccion/produccion_tecnologica_innovacion/desarrollo_software.php" method="POST">

                                                                    <div class="form-group">
                                                                          <label for="titulo_soft" required>Título:</label>
                                                                          <input type="text" class="form-control titulo_soft" name="titulo_soft" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="tip_soft" required>Tipo de desarrollo:</label>
                                                                          <input type="text" class="form-control tip_soft" name="tip_soft" placeholder="" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                     ...
                                                                     <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control hrs_hombre" name="hrs_hombre" placeholder="" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control costo" name="costo" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="beneficiario" required>Beneficiario:</label>
                                                                          <input type="text" class="form-control beneficiario" name="beneficiario" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="objetivo" required>Objetivo:</label>
                                                                          <input type="text" class="form-control objetivo" name="objetivo" placeholder="" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control contribucion" name="contribucion" placeholder="" required>
                                                                    </div>
