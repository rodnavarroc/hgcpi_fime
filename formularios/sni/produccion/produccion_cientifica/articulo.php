                                                                    ...
                                                                    <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control issn" name="issn" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="nombre" required>Nombre del artículo:</label>
                                                                          <input type="text" class="form-control nombre" name="nombre" placeholder="" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                     ...
                                                                     <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control num_revista" name="num_revista" placeholder="" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                          <label for="vol_revista" required>Volumen de la revista:</label>
                                                                          <input type="text" class="form-control vol_revista" name="vol_revista" placeholder="" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                          ...
                                                                          <input type="text" class="form-control pag_inic" name="pag_inic" placeholder="" required>
                                                                        </div>

                                                                        <div class="form-group">
                                                                          <label for="pag_fin_art" required>Página final del artículo:</label>
                                                                          <input type="text" class="form-control pag_fin" name="pag_fin" placeholder="" required>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control fond_prog" name="fond_prog" placeholder="" required>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="idthomson_art" required>Researcher ID Thomson:</label>
                                                                            <input type="text" class="form-control idthomson_art" name="idthomson_art" placeholder="" required>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="idarxiv_art" required>arXiv ID:</label>
                                                                            <input type="text" class="form-control idarxiv_art" name="idarxiv_art" placeholder="" required>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="idpubmed_art" required>PubMed ID:</label>
                                                                            <input type="text" class="form-control idpubmed_art" name="idpubmed_art" placeholder="" required>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="idopen_art" required>Open ID:</label>
                                                                            <input type="text" class="form-control idopen_art" name="idopen_art" placeholder="" required>
                                                                        </div>
