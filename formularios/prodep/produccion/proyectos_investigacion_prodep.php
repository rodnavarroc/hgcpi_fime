...
<div class="form-group">
   ...
   <input type="text" class="form-control inst_certi" name="LGAC_proyecto_investigacions_prodep"placeholder="">
   </div>
   ...
   <input type="text" class="form-control inst_certi" name="inicio_proyecto_investigacion_prodep" placeholder="" required>
   </div>       

 <div class="form-group">
   <label for="descripcion" required> (31/12/9999) <br>Fecha de fin: </label>
   <input type="text" class="form-control inst_certi" name="fin_proyecto_investigacion_prodep" placeholder="" required>
   </div>       
