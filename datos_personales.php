          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control" name="nueva_clave" placeholder="" required="true" style="background-color: #e0f0ff;">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" name="numero_exterior_dom" placeholder="310" required="true">
				  </div>
				  <div class="form-group">
				    <label for="exampleFormControlInput1">Número de residencia interior</label>
				    <input type="text" class="form-control" name="numero_interior_dom" placeholder="205" required="true">
				  </div>
				  <div class="form-group">
